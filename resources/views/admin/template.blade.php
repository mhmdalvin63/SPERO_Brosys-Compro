...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="#"><img src="{{asset('../images/logo-brosys.png')}}" width="90" alt="Logo" srcset=""></a>
            </div>
    ...
    <div class="sidebar-menu">
        ...
        <li class="sidebar-title">Menu</li>
            <li
                class="sidebar-item {{ (request()->is('admin/event')) ? 'active' : '' }}">
            ...
            <li
                class="sidebar-item {{ (request()->is('admin/header')) ? 'active' : '' }}">
                <a href="/admin/header" class='sidebar-link'>
